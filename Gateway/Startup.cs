        ...
        public void ConfigureServices(IServiceCollection services)
        {
            services.AddCors(corsOpt => {
                corsOpt.AddPolicy(name: "MyPolicy", builder => {
                    builder.WithOrigins("http://localhost:1302",
                        "http://dev-order.grcboard.com", "https://dev-order.grcboard.com",
                        "http://order.grcboard.com", "https://order.grcboard.com",
                        "http://apiv1.1000saudara.com", "https://apiv1.1000saudara.com",
                        "http://api-merchant.1000saudara.com", "https://api-merchant.1000saudara.com").AllowCredentials()
